...
namespace GameRequest
{
    class HTTPRequest
    {
        ...
        private static readonly string DRAGNDROP_URL = API_URL + "update/drag/" + PlayerPrefs.GetInt("Games_Museum");
        private static readonly string TRIVIA_URL = API_URL + "update/trivia/" + PlayerPrefs.GetInt("Games_Museum");
